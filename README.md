...
测试2： 使用 model = epoch_7-batch_2700-loss_0.094469，新增85条新样本重新训练  
正常样本：最小相似度=0.9047877788543700，大于0.59相似度的合格率为100%  具体看positive_new.csv  
异常样本：最大相似度=0.587344437837601  具体看negative_new.csv  
